...
1. Start the program and import the required libraries for the Decision Tree Classifier.
2. Load the employee dataset containing details related to employee performance and churn.
3. Split the dataset into training and testing data.
4. Train the Decision Tree Classifier model using the training dataset.
5. Predict employee churn using the test data and display the prediction results.
...
<img width="695" height="337" alt="8" src="https://github.com/user-attachments/assets/d0625b60-d75e-4d54-8a44-ff603c3af9fd" />

<img width="1187" height="625" alt="8b" src="https://github.com/user-attachments/assets/8ffb80d7-6ffe-4efa-bd99-0232a955c1a0" />
